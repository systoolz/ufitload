/*
 * Version 1.8, 2025-10-08, SysTools, http://systools.losthost.org/
 *   - Current code based on: https://achurch.org/tinflate.c
 *   - moved down tinflate_partial() to fix warning use before declare
 *   - Added NO_CRC32 macro to reduce code size.
*/
